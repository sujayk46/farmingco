...
function Demo() {
    ...
    return (
        <>
            ...
            <div className="bg-gradient-to-r from-Accent  to-Tertiary">
                <Button variant="contained" onClick={() => handleIncrementByAmount(5)}>Increment by 5</Button>
            </div>
            <p className="mt-8 font-roboto font-extrabold">
                    Edit <code>src/pages/Demo.tsx</code> and save to test HMR
            </p>
            <p className="read-the-docs mt-2 font-montserrat font-extrabold">
